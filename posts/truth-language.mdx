...
**Is it possible to create a language in which true statements are ungrammatical?**

It is theoretically possible to create a language in which true statements are ungrammatical, but it would be highly unusual and would likely not be a very practical or functional language.

Language is a means of communication, and the primary purpose of language is to convey meaning from one person to another. In order for a language to be useful, it must have a certain level of consistency and predictability. The grammar of a language provides the rules for constructing meaningful sentences that can be understood by speakers of the language.

If true statements were ungrammatical in a language, then the language would be highly unpredictable and difficult to use effectively.
...
**Requests and responses have been edited for brevity; also, h/t Gödel, Chomsky, Church-Turing, Liebniz.... they have been my inputs here.**

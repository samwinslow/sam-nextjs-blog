...
It is like inspecting a leaf and finding patterns of veins that get smaller and smaller while being of equal density the entire time — a set that is [everywhere dense](https://encyclopediaofmath.org/wiki/Dense_set). Or many of the structures in nature which Buckminster Fuller talks about. Or [the geometry of the experience of DMT](https://www.youtube.com/watch?v=loCBvaj4eSg).
